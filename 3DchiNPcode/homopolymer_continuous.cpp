...
complex<double> homopolymer_continuous_gsd(complex<double> *WA,
  ...
  q_old = (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
  dum_arr = (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
  lambda = (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
