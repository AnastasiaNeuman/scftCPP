...
complex<double> homopolymer_discrete(complex<double> *WA,
  ...
  qf = (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
  h =  (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
  a =  (complex<double>*) fftw_malloc(sizeof(complex<double>)*size1);
